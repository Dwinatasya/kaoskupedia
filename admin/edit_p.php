      ...
      <div class="container-md mt-5">
        <div class="card"><!-- card -->
          ...
          <div class="card-body ">
            ...
            <?php
            $id_produk =$_GET['id'];
            $tampil = mysqli_query($con,"SELECT * FROM tb_produk WHERE id_produk='$id_produk'");
            $edit = mysqli_fetch_array( $tampil);
            ?>
            <form method="POST" action="aksi_edit_p.php"   enctype="multipart/form-data" >
            <input type="hidden" value="<?php echo $id_produk;?>" name="id_produk">
           
              <div class="form-group row ml-5">
                <label class="col-sm-3 col-form-label" >Nama Produk</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="nama_produk"  value="<?php echo $edit['nama_produk']; ?>" >
                  </div>
              </div>
              <!--
              <div class="form-group row ml-5 ">
                <label class="col-sm-3 col-form-label">Foto Produk</label>
                  <div class="col-sm-8">
                    <input type="file" class="form-control"  name="foto_produk" value="<?php echo $edit['foto_produk']; ?>">
                    <em class="text-success">Foto Saat ini: <?php// echo $edit['foto_produk']; ?></em>
                  </div>
              </div>
              -->
              <div class="form-group row ml-5 ">
                <label class="col-sm-3 col-form-label" >Status</label>
                  <div class="col-sm-8">
                    <input type="radio"  name="deskripsi_produk" value="Dijual">Dijual
                    <input type="radio"  name="deskripsi_produk" value="Terjual">Terjual
                    <br>
                    <em class="text-danger">wajib isi</em>
                  </div>
              </div>

              <div class="form-group row ml-5">
                <div class="col-sm-5">
                  <input type="number" class="form-control"  name="harga_produk"  value="<?php echo $edit['harga_produk']; ?>"  >
                </div>

                <div class="col-sm-5">
                    <select class="form-control" name="ukuran_produk">
                    <option  value="<?php echo $edit['ukuran_produk']; ?>"><?php echo $edit['ukuran_produk']; ?></option>
