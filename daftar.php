  ...
  <body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){ 
        ...
        elseif(empty($password))//validasi password
        {
            ...
            $save=mysqli_query($con, "INSERT INTO tb_user (nama, alamat, no_telp, email, password)
            values ('$nama','$alamat','$no_telp','$email','$password')");   
             if($save){ 
                echo "<script>alert('Pendaftaran Berhasil!');document.location='masuk.php'</script>";
            }else{//jika simpan gagal maka muncul pesan
            echo "<script>alert('Maaf Proses Daftar Gagagl!');document.location='daftar.php'</script>";
            } 
        }  
    }
